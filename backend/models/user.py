...
class User(db.Model):
    ...
    department = db.Column(db.String(100), nullable=False)  # Can be: admin, management, production, purchase, store, assembly, finance, showroom, sales, dispatch, watchman, transport, hr, reception
