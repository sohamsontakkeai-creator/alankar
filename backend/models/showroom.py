...
class ShowroomProduct(db.Model):
    ...
    quantity = db.Column(db.Integer, default=1)  # Number of machines in this showroom product
...
class GatePass(db.Model):
    ...
    issued_at = db.Column(db.DateTime, default=get_ist_now)
    verified_at = db.Column(db.DateTime, nullable=True)
    # Photo paths captured by watchman during verification
