...
class OrderTrackingService:
    ...
    def _calculate_estimated_completion(progress_percentage):
        ...
        estimated_date = get_ist_now() + timedelta(days=days_to_completion)
        ...
        if dispatch_order:
            ...
            if dispatch_order.status in ['in_transit', 'assigned_transport']:
                return {
                    ...
                    'updated_at': getattr(dispatch_order, 'updated_at', get_ist_now()).isoformat()
                }
        ...
        if sales_order:
            ...
            if finance_status in ['pending_finance_approval', 'finance_approved', 'finance_rejected']:
                return {
                    ...
                    'updated_at': getattr(sales_order, 'updated_at', get_ist_now()).isoformat()
                }
