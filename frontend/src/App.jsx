...
const ProtectedRoute = ({ user, department, children }) => {
    ...
    // Management can access everything (read-only handled in components)
    ...
    <Router>
      ...
      <div className="min-h-screen">
        <Routes>
          ...
          <Route path="/dashboard/reception" element={<ProtectedRoute user={user} department="reception"><ReceptionDashboard /></ProtectedRoute>} />
          <Route
            path="/"
